...
class VoucherVaultApiClient:
    ...
    async def authenticate_basic(self) -> bool:
        ...
        session = await self.perform_login_action()
        if session is None:
            _LOGGER.error(
    ...
    async def perform_login_action(self) -> aiohttp.ClientSession | None:
    ...
    async def get_stats(self) -> dict:
        ...
        """
        return await self.send_api_request("GET", "/en/api/get/stats")
